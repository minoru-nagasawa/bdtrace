...
TEST_SRCS = tests/test_main.cpp tests/test_database.cpp tests/test_scalability.cpp \
            tests/test_trace_simple.cpp \
            ...
            tests/test_analysis.cpp tests/test_cmd_name.cpp
